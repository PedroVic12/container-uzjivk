...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-uzjivk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-uzjivk.containers.anotherwebservice.com/
...
```
git clone git@github.com:PedroVic12/container-uzjivk.git
cd container-uzjivk
```
...
```
docker attach container-uzjivk
```
